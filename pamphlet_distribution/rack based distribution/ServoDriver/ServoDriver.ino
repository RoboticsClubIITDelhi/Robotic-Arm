...
// screenUpdate();
void dance() {
    st.WritePosEx(0, 734, 500, 0);
    delay(1000); 
    st.WritePosEx(2, 669, 500, 0);
    delay(1000); 
    st.WritePosEx(1,745,500,0);
    delay(1000); 
    st.WritePosEx(2, 720, 500, 0);
    delay(1000); 
    st.WritePosEx(0, 836, 500, 0);
    delay(1000);  
    st.WritePosEx(2, 806, 500, 0);
    delay(1000); 
    st.WritePosEx(0, 751, 500, 0);
    delay(1000); 
    st.WritePosEx(2, 840, 500, 0);
    delay(1000);  
    st.WritePosEx(0, 728, 500, 0);
    delay(1000); 
    st.WritePosEx(2, 865, 500, 0);
    delay(1000); 
    st.WritePosEx(0, 688, 500, 0);
    delay(1000); 
    st.WritePosEx(2, 904, 500, 0);
    delay(1000); 
    st.WritePosEx(0, 550, 200, 0);
    delay(1000); 
    st.WritePosEx(1, 504, 500, 0);
    delay(1000); 
    st.WritePosEx(0,619,500,0);
    delay(5000);
}